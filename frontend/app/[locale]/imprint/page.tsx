...
export default function Imprint(){
	return(
     <div className="impressum-wrapper p-4 max-w-4xl mx-auto text-justify">
      ...
      <p>
        ...
        <br />
        Präsident Prof. Dr. Dr. h.c. Gordon Thomas Rohrmair
      </p>
      <p>
        ...
        <br />
        E-Mail:{' '}
        <a href="mailto:info@tha.de" className="text-blue-600 underline">
          info@tha.de
        </a>
      </p>
